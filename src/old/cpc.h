...
//
	...
	public:
		...
		ResultCode get_code() const { return report.code; }
...
// RAIDA service
	 ...
	 */
	std::tuple<std::vector<NodeResponse>, ResultReport> echo(std::vector<NodeID> &nodes, bool brief = false);
